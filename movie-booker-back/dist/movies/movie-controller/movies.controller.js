...
const movies_service_1 = require("../movie-service/movies.service");
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer une liste de films avec pagination, recherche et tri' }),
